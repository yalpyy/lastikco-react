...
$sql = "SELECT * FROM cars WHERE durum = 0";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['aktif_gonder'])) {
    ...
    // Durumu güncelle
    $updateSql = "UPDATE cars SET durum = 1 WHERE car_id = '$carId'";
            ...
            if ($axlesResult->num_rows > 0) {
                ...
                ?>
                        ...
                        ?>
                                        ...
                                        <button type="submit" name="aktif_gonder" class="btn btn-danger">Aktif Yap</button>
