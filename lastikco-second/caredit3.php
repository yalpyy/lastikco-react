...
?>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="tier_olcumtarihi" name="tier_olcumtarihi" placeholder="Ölçüm Tarihi">
                ...
                <tbody>
                    <tr>
                        <td>Sağ Ön<input type="radio" id="1akssag" name="aks" value="1.AksSağÖn"  style="height:35px; width:35px; vertical-align: middle;"onchange="updatePosition(this)" required></td>
                        <td></td>
                        <td>Sağ Dış<input type="radio" id="2akssagdıs" name="aks" value="2.AksSağDış"  style="height:35px; width:35px; vertical-align: middle;"onchange="updatePosition(this)" required></td>
                        <td>Sağ Dış<input type="radio" id="3akssagdıs" name="aks" value="3.AksSağDış" style="height:35px; width:35px; vertical-align: middle;" onchange="updatePosition(this)" required></td>
                        <td>Sağ Dış<input type="radio" id="4akssagdıs" name="aks" value="4.AksSağDış"style="height:35px; width:35px; vertical-align: middle;"  onchange="updatePosition(this)" required></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                        <td>Sağ İç<input type="radio" id="2akssagıc" name="aks" value="2.AksSağİç" style="height:35px; width:35px; vertical-align: middle;" onchange="updatePosition(this)" required></td>
                        <td>Sağ İç<input type="radio" id="3akssagıc" name="aks" value="3.AksSağİç"  style="height:35px; width:35px; vertical-align: middle;"onchange="updatePosition(this)" required></td>
                        <td>Sağ İç<input type="radio" id="4akssagıc" name="aks" value="4.AksSağİç" style="height:35px; width:35px; vertical-align: middle;" onchange="updatePosition(this)" required></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td>Sol İç <input type="radio" id="2akssolıc" name="aks" value="2.AksSolİç"  style="height:35px; width:35px; vertical-align: middle;"onchange="updatePosition(this)" required></td>
                        <td>Sol İç <input type="radio" id="3akssolıc" name="aks" value="3.AksSolİç" style="height:35px; width:35px; vertical-align: middle;" onchange="updatePosition(this)" required></td>
                        <td>Sol İç <input type="radio" id="4akssolıc" name="aks" value="4.AksSolİç" style="height:35px; width:35px; vertical-align: middle;" onchange="updatePosition(this)" required></td>
                    </tr>
                    <tr>
                        <td>Sol Ön<input type="radio" id="1akssolon" name="aks" value="1.AksSolÖn" style="height:35px; width:35px; vertical-align: middle;" onchange="updatePosition(this)" required></td>
                        <td></td>
                        <td>Sol Dış <input type="radio" id="2akssoldıs" name="aks" value="2.AksSolDış" style="height:35px; width:35px; vertical-align: middle;"onchange="updatePosition(this)" required></td>
                        <td>Sol Dış <input type="radio" id="3akssoldıs" name="aks" value="3.AksSolDış" style="height:35px; width:35px; vertical-align: middle;"onchange="updatePosition(this)" required></td>
                        <td>Sol Dış <input type="radio" id="4akssoldıs" name="aks" value="4.AksSolDış" style="height:35px; width:35px; vertical-align: middle;"onchange="updatePosition(this)" required></td>
                    </tr>
                </tbody>
            </table>
